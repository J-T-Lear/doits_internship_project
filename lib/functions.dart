...
//This part is for building each User entry in the List
Widget buildUserTile(User user) => GestureDetector(
      onTap: () {
        print(user.name);
      },
      child: Padding(
            ...
            Expanded(
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                  border: Border(
                    top: BorderSide(
                        width: 2, color: Color.fromARGB(255, 207, 216, 220)),
                    left: BorderSide(
                        width: 1, color: Color.fromARGB(255, 207, 216, 220)),
                    bottom: BorderSide(
                      width: 0,
                    ),
                  ),
